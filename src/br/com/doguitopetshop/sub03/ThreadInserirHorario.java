...
public class ThreadInserirHorario implements Runnable {
    private SSLSocket socket;
    private ServidorInserirHorario servidor;
    private ExecutorService threadPool;
    private int contadorIdMensagem;

    public ThreadInserirHorario (ExecutorService threadPool, SSLSocket socket, ServidorInserirHorario servidor,
    ...
    public void run() {
        try {
            ...
            String orienta = "Digite (inserir horario) para confirmação: ";
            ...
            printSaida.println(resposta.inserirHorario(Protocolo.OP_INSERIR_HORARIO, tabelaAgenda, socket,
